...
function AddDoctors() {
    ...
    const { data: specialityAbout, isLoading } = useQuery({
        queryKey: ['specilityAbout'],
        queryFn: () =>
            axios({
                method: 'GET',
                url: `${process.env.REACT_APP_devUrl}/specilityAbout`,
            }),
    });
    ...
    const onSubmit = async (data) => {
        try {
            ...
            const doctorInfo = {
                name: data.name,
                img: imageRes.data.data.display_url,
                email: data.email,
                specialist: data.specialist,
            };
            const postRes = await axios({
                method: 'POST',
                url: `${process.env.REACT_APP_devUrl}/doctors`,
                headers: {
                    authorization: `bearer ${localStorage.getItem('accessToken')}`,
                },
                data: doctorInfo,
            });
            if (postRes.data.acknowledged) {
            ...
            >
                ...
                <div className="mb-6">
                    ...
                    >
                        ...
                        {specialityAbout?.data?.map((speciality) => (
